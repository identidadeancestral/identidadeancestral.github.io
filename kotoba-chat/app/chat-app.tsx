  ...
  return <div className="app-frame">
    ...
    <div className={"chat-shell"+(mobileChat?" mobile-chat":"")}>
      <aside className="people-panel">
        ...
        <div className="learning-shortcuts"><Button variant="outline" onClick={()=>{setStudyEntry("");setLibraryOpen(true);}}><BookOpen/>{t("300 palavras e flexões","300 words and forms")}</Button><a href={EBOOK_URL} target="_blank" rel="noopener noreferrer">{t("Conhecer o ebook · Método 100 Blocos","Explore the ebook · Método 100 Blocos")}<ArrowUpRight/></a></div>
