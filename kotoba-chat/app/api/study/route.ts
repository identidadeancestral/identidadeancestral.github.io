...
async function route(req:Request) {
 try{const db=getChatDb(),identity=await requestIdentity(req,db);return cors(req,await handleStudy(req,db,identity.authKey,identity.external&&!!identity.authKey));}
